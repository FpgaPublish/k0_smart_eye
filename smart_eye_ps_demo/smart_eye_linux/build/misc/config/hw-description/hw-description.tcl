...
proc plnx_gen_conf_serial {mapping kconfprefix cpuname cpuslaves} {
	...
	if { [string match -nocase "*aarch64*" $current_arch ] } {
		...
		} elseif { [regexp "psxl_cortexa78*" $cpuname matched] == 1 } {
			set components_list "PLM ATF DTG"
...
proc generate_mapping_list {args} {
	...
	foreach devtype ${devicetypes} {
		...
		if {"${devtype}" == "sd"} {
			lappend devtype_mapping "processor_ip ps7_cortexa9 psu_cortexa53 psv_cortexa72 psxl_cortexa78 psx_cortexa78"
