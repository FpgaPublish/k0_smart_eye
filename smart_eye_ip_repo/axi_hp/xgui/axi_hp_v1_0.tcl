...
proc init_gui { IPINST } {
  ...
  set_property tooltip {axi setting} ${Page_0}
  ...
  #Adding Page
  set user_setting [ipgui::add_page $IPINST -name "user setting" -display_name {shk setting}]
  set_property tooltip {shk setting} ${user_setting}
  ipgui::add_param $IPINST -name "MD_WRITE_ID" -parent ${user_setting}
  ipgui::add_param $IPINST -name "WD_BYTE_SUM" -parent ${user_setting}


}

proc update_PARAM_VALUE.MD_WRITE_ID { PARAM_VALUE.MD_WRITE_ID } {
	# Procedure called to update MD_WRITE_ID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MD_WRITE_ID { PARAM_VALUE.MD_WRITE_ID } {
	# Procedure called to validate MD_WRITE_ID
	return true
}
...
proc update_MODELPARAM_VALUE.MD_WRITE_ID { MODELPARAM_VALUE.MD_WRITE_ID PARAM_VALUE.MD_WRITE_ID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MD_WRITE_ID}] ${MODELPARAM_VALUE.MD_WRITE_ID}
}
